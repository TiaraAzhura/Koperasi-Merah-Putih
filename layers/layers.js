...
lyr_Satelite_0.setVisible(true);lyr_KecamatanKabBandung_1.setVisible(true);lyr_KoperasiMerahPutih_2.setVisible(true);
...
lyr_KoperasiMerahPutih_2.set('fieldAliases', {'No': 'No', 'Nama Koper': 'Nama Koper', 'Alamat': 'Alamat', 'Koordinat': 'Koordinat', 'Y': 'Y', 'X': 'X', 'Luas Lahan': 'Luas Lahan', });
...
map.on('singleclick', function(evt) {
    ...
    if (feature && feature.get('Nama Koper')) {
        ...
        var html = '<b>' + nama + '</b><br>' +
                   alamat + '<br>' +
                   'Luas: ' + luas + '<br>';

        if (foto) {
            html += '<br><img src="images/' + foto + '" width="200px">';
        }
